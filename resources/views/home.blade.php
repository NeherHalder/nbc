        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('varificatino.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="committee" required value="1">Yes
                                    </label>
                                    <label>
                                        <input type="radio" name="committee" required value="0">No
                                    </label>
                                </div>
